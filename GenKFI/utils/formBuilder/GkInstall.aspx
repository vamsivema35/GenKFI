...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyHolder" runat="server">
        <div style="Text-align:center; width: 50%; margin: auto;">
            ...
            <asp:TextBox runat="server" ID="txtInstName" Width="150"></asp:TextBox> 
            <span>Install Name as a Install group</span> <br />
            <asp:Label runat="server" ID="lblCmd" ForeColor="Maroon" Text="Command: "></asp:Label>
            <asp:TextBox runat="server" ID="txtCmd" Width="150"></asp:TextBox> 
            <span>Command (listed above) </span> <br />
            <asp:Label runat="server" ID="lblFileType" ForeColor="Maroon" Text="FileType: "></asp:Label>
            <asp:TextBox runat="server" ID="txtFileType" Width="150"></asp:TextBox> 
            <span>FileType Name</span> <br />
            <asp:Label runat="server" ID="lblTable" ForeColor="Maroon" Text="Table: "></asp:Label>
            <asp:TextBox runat="server" ID="txtTable" Width="150"></asp:TextBox> 
            <span>Table Name</span> <br />
            <asp:Label runat="server" ID="lblColumn" ForeColor="Maroon" Text="Column: "></asp:Label>
            <asp:TextBox runat="server" ID="txtColumn" Width="150"></asp:TextBox>
            <span>Column Name</span> <br />
            <asp:Label runat="server" ID="lblDataType" ForeColor="Maroon" Text="DataType: "></asp:Label>
            <asp:TextBox runat="server" ID="txtDataType" Width="150"></asp:TextBox>
            <span>money, tinyint, smallint, datetime, varchar(x)</span> <br />
            <asp:Label runat="server" ID="lblNull" ForeColor="Maroon" Text="NOT (Null): "></asp:Label>
            <asp:TextBox runat="server" ID="txtNull" Width="150" Text="NOT"></asp:TextBox>
            <span>NOT or blank for Null</span> <br />
            <asp:Label runat="server" ID="lblDefault" ForeColor="Maroon" Text="Default: "></asp:Label>
            <asp:TextBox runat="server" ID="txtDefault" Width="150"></asp:TextBox>
            <span>ZERO, BLANK, EMPTY, BATCH, GETDATE, HIGHDATE, or item </span> <br />
            ...
            <span>fstrField1, fstrField2</span> <br />
            <asp:Button runat="server" ID="btnAdd" Text="Add Entry" OnClick="OnClick_AddEntry" ></asp:Button> <br />
            <asp:Button runat="server" ID="btnTechTeam" Text="Tech Team" OnClick="OnClick_TechTeam" ></asp:Button> <br />
            <asp:Button runat="server" ID="btnScript" Text="Script" OnClick="OnClick_Script" ></asp:Button> <br />
            <asp:Button runat="server" ID="btnInstall" Text="Install" OnClick="OnClick_Install" ></asp:Button> <br />
            <asp:Button runat="server" ID="btnClear" Text="Clear File" OnClick="OnClick_Clear" ></asp:Button> <br />
            <asp:Button runat="server" ID="btnReLink" Text="Re-Link" OnClick="OnClick_ReLink" ></asp:Button> <br />
            ...
            <asp:TextBox runat="server" ID="TxtPBatchId" Width="150"></asp:TextBox>
