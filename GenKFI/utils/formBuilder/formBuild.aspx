<%@ Page Language="C#" MasterPageFile="~/forms.Master" AutoEventWireup="True" CodeBehind="formBuild.aspx.cs" Inherits="GenKFI.utils.formBuilder.FormBuild" %>
	...
	<style type="text/css">
		...
		<div id="divHeader" style="position:absolute;top:0px;left:0px;height:72px;width:100%;" runat="server">
            ...
            <asp:Button runat="server" ID="btnSub" Text="Done" Style="left: 860px; top: 13px; position: absolute; height: 45px; font-size: 20px; font-weight: bold; z-index: 10;" OnClick="OnClick_btnSub" />
					...
					<h3>Block Options</h3>
						<div id="addControl" style="overflow:scroll;">
							<table>
								...
								<tr>
									<td><asp:Button runat="server" ID="addBTN" Text="Add Control" OnClick="OnClick_addBTN" /></td>
									<td><asp:Button runat="server" ID="moveUpBTN" Text="Move Control Up" OnClick="OnClick_moveUpBTN" /></td>
									<td><asp:Button runat="server" ID="testBTN" Text="Test Page" OnClick="OnClick_testBTN" /></td>
								</tr>
								<tr>
									<td><asp:Button runat="server" ID="removeBTN" Text="Remove Control" OnClick="OnClick_removeBTN" /></td>
									<td><asp:Button runat="server" ID="moveDnBTN" Text="Move Control Down" OnClick="OnClick_moveDnBTN" /></td>
									<td></td>
								</tr>
								<tr>
									<td colspan="3">
								...
								<tr>
									<td><input type="button" id="useValsClip" value="Apply Clip Values" /></td>
									<td>
						...
						<div id="controlOptions" style="overflow:scroll;">
							<table>
								...
								<tr>
									<td>Label: </td>
									<td><asp:TextBox runat="server" ID="labelTXT" Width="200"></asp:TextBox></td>
								</tr>
								<tr>
									<td><asp:CheckBox runat="server" ID="lookupCKB" Text="Do Lookup?" /></td>
									<td><asp:CheckBox runat="server" ID="vertSkipCKB" AutoPostBack="true" Text="2nd Column" /></td>
								</tr>
								<tr>
									<td>Control ID: </td>
									<td><asp:TextBox runat="server" ID="inputIDTXT" Width="200"></asp:TextBox></td>
								</tr>
								<tr>
									<td>Max/Display Length: </td>
									<td><asp:TextBox runat="server" ID="maxLenTXT" Width="100"></asp:TextBox><asp:TextBox runat="server" ID="dispLenTXT" Width="75"></asp:TextBox></td>
								</tr>
								<tr>
									<td>KFI Column: </td>
									<td><asp:TextBox runat="server" ID="columnIDTXT" Width="200"></asp:TextBox></td>
								</tr>
								<tr>
									<td>GenTax Field: </td>
									<td><asp:TextBox runat="server" ID="gentaxFieldTXT" Width="200"></asp:TextBox></td>
								</tr>
								<tr id="imgMove" class="moveRow">
									<td>Image Scrolling (X, Y): </td>
									<td><asp:TextBox runat="server" ID="imageXTXT" Width="100"></asp:TextBox><asp:TextBox runat="server" ID="imageYTXT" Width="100"></asp:TextBox></td>
								</tr>
								<tr id="markerMove" class="moveRow">
									<td>Marker Position (X, Y): </td>
									<td><asp:TextBox runat="server" ID="markerXTXT" Width="100"></asp:TextBox><asp:TextBox runat="server" ID="markerYTXT" Width="100"></asp:TextBox></td>
								</tr>
								<tr id="controlMove" class="moveRow">
									<td>Control Scroll Position</td>
									<td><asp:TextBox runat="server" ID="controlScrollTXT" Width="200"></asp:TextBox></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><asp:TextBox runat="server" ID="ckbTransTXT" Width="200"></asp:TextBox></td>
								</tr>
								<tr>
									<td>Next Control: </td>
									<td><asp:DropDownList runat="server" ID="nextControlDDL" Width="200"></asp:DropDownList></td>
								</tr>
								<tr>
									<td><asp:CheckBox runat="server" ID="hiddenCKB" Text="Hidden" /></td>
									<td><asp:CheckBox runat="server" ID="requiredCKB" Text="Required to Submit?" /></td>
								</tr>
								<tr>
									<td></td>
									<td><asp:Button runat="server" ID="saveOptionsBTN" Text="Save Options" OnClick="OnClick_saveOptionsBTN" /></td>
								</tr>
							</table>
