...
{
    /// <summary>
    /// Summary description for GRTRateLookup
    /// </summary>
    public class GRTRateLookup : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                string statement = "SELECT fcurRate FROM rfrGrtRate WHERE '";
                statement += context.Request.Form["GRTPeriodEnd"].ToString() + "' >= fdtmStart AND '";
                statement += context.Request.Form["GRTPeriodEnd"].ToString() + "' <= fdtmEnd AND ";
